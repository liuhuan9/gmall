...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("D:\\ideaspace\\gmall-parent\\gmall-mbg" + "/src/main/java");
        gc.setAuthor("Lfy");
        ...
        dsc.setUrl("jdbc:mysql://192.168.1.103:3306/gmall_"+moduleName+"?useUnicode=true&useSSL=false&characterEncoding=utf8");
